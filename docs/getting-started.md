...
- Chroma is integrated in [LangChain](https://python.langchain.com/docs/integrations/vectorstores/chroma) (`python` and `js`), making it easy to build AI applications with Chroma. Check out the [integrations](./integrations) page to learn more.
